...
golf: golf.o lexer.o token.o logger.o input.o file_input.o repl_input.o ast.o parser.o
	g++ -g golf.o lexer.o token.o logger.o input.o file_input.o repl_input.o ast.o parser.o -o golf
